#!/usr/bin/env bash
# CORA — advisory writer lock for a shared clone (ported from chora@f260b81 bin/writelock.sh,
# sha256 f4aaa920d89444121817193e4850794046db023f73eff30a813a839c97d5792b; the port keeps every
# behaviour that made it survive, and only the lock file name and the log line changed).
#
